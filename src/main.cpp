...
#include <vector>
#include <memory>
#include "GLViewLatticeVisualization.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewLatticeVisualization > glView( Aftr::GLViewLatticeVisualization::New( args ) );
