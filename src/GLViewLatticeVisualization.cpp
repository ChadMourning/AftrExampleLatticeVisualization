#include "GLViewLatticeVisualization.h"
...
GLViewLatticeVisualization* GLViewLatticeVisualization::New( const std::vector< std::string >& args )
{
   GLViewLatticeVisualization* glv = new GLViewLatticeVisualization( args );
...
GLViewLatticeVisualization::GLViewLatticeVisualization( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewLatticeVisualization::New() for
   ...
   //GLViewLatticeVisualization::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewLatticeVisualization::onCreate()
{
   //GLViewLatticeVisualization::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewLatticeVisualization::~GLViewLatticeVisualization()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewLatticeVisualization::updateWorld()
{
...
void GLViewLatticeVisualization::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewLatticeVisualization::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewLatticeVisualization::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewLatticeVisualization::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewLatticeVisualization::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewLatticeVisualization::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}


void Aftr::GLViewLatticeVisualization::loadMap()
{
   ...
   createLatticeVisualizationWayPoints();
}


void GLViewLatticeVisualization::createLatticeVisualizationWayPoints()
{
